...
export const translations = {
  nav: {
    ...
    news: { EN: 'News', KR: '뉴스', CN: '新闻', JP: '뉴스', TH: 'ข่าวสาร', VN: 'Tin tức', ID: 'Berita', MY: 'Berita' },
  ...
  about: {
    ...
    p1: { 
      ...
      JP: 'J PRO Tradingは単なる商社ではなく、国際貿易의複雑な課題を共に解決していく戦略的パートナーです。すべての取引が持続可能な信頼を築く機会であると確信しています。', 
    ...
    p2: { 
      ...
      VN: 'Kể từ khi thành lập, chúng tôi đã mở rộng phạm vi hoạt động khắp Hoa Kỳ, Châu Âu, Hàn Quốc và Nhật Bản, chuyên về xuất khẩu các thương hiệu cao cấp. Sứ mệnhของ chúng tôi là nâng tầm thị trường nội địa bằng chất lượng toàn cầu.',
      ...
      MY: 'Sejak penubuhan kami, kami telah memperluas jejak kami di seluruh AS, Eropah, Korea, dan Jepun, khusus dalam eksport jenama premium. Misi kami adalah untuk memperkasakan pasาร tempatan dengan kualiti global, memastikan kecemerlangan tidak mengenal sempadan.'
    },
    values: {
      ...
      v3_desc: { EN: 'Our success is measured by the success of our partners.', KR: '우리의 성공은 파트너사의 성공으로 측정됩니다.', CN: '我们的成功取决于合作伙伴의成功。', JP: '私たちの成功は、パートナー企業の成功によって測られます。', TH: 'ความสำเร็จของเราวัดจากความสำเร็จของพันธมิตรของเรา', VN: 'Thành công của chúng tôi được đo bằng thành côngของ đối tác.', ID: 'Kesuksesan kami diukur dari kesuksesan mitra kami.', MY: 'Kejayaan kami diukur melalui kejayaan rakan kongsi kami.' }
    },
  ...
  services: {
    ...
    s2_desc: { EN: 'Tailored retail strategies targeting high-end luxury markets.', KR: '하이엔드 마켓을 타겟으로 한 맞춤형 리테일 전략.', CN: '针对高端奢侈品市场的定制零售策略。', JP: 'ハイエンド市場をターゲットとした、カスタマイズされた小売戦略。', TH: 'กลยุทธ์การขายปลีกที่ปรับแต่งมาเพื่อตลาดหรูหราระดับไฮเอนด์', VN: 'Chiến lược bán lẻ được điều chỉnh cho các thị trường xa xỉ cao cấp.', ID: 'Strategi ritel khusus yang menargetkan pasar mewah kelas atas.', MY: 'Strategi runcit tersuai yang mensasarkan pasaran mewah mewah.' },
    s3_title: { EN: 'Trade & Logistics', KR: '무역 및 물류', CN: '贸易与物流', JP: '貿易・物流', TH: 'การค้าและโลจิสติกส์', VN: 'Thương mại & Hậu cần', ID: 'Perdagangan & Logistik', MY: 'Perdagangan & Logistik' },
    ...
    pageHeader: { EN: 'Global Trade Excellence', KR: '글로벌 무역의 정점', CN: '全球贸易卓越', JP: 'グローバル貿易の頂점', TH: 'ความเป็นเลิศทางการค้าระหว่างประเทศ', VN: 'Xuất sắc trong thương mại toàn cầu', ID: 'Keunggulan Perdagangan Global', MY: 'Kecemerlangan Perdagangan Global' },
    pageSubtitle: { EN: 'Strategic Partner for Your Global Business Expansion.', KR: '당신의 글로벌 비즈니스 확장을 위한 전략적 파트너.', CN: '您全球业务扩张的战略合作伙伴。', JP: 'グローバルビジネス拡大のための戦略的パートナー.', TH: 'พันธมิตรเชิงกลยุทธ์สำหรับการขยายธุรกิจระดับโลกของคุณ', VN: 'Đối tác chiến lược cho việc mở rộng kinh doanh toàn cầu của bạn.', ID: 'Mitra Strategis untuk Ekspansi Bisnis Global Anda.', MY: 'Rakan Strategik untuk Pengembangan Perniagaan Global Anda.' },
    exportSection: {
  ...
  news: {
    ...
    titles: {
      ...
      t3: {
        ...
        VN: "Tầm quan trọngของ chuyển đổi số trong lĩnh vực phân phối bán buôn",
    ...
    page: {
      ...
      desc: { EN: 'We provide strategic proposals and the latest market intelligence to empower our global partners.', KR: '우리는 글로벌 파트너들의 성장을 위해 전략적인 비즈니스 제안과 최신 시장 지능을 제공합니다.', CN: '我们提供战略建议和最新的市场情报，以为我们的全球合作伙伴赋能。', JP: 'グローバルパートナーの皆様の成長のために、戦略적인ビジネス提案と最新の市場インテリジェンスを提供します。', TH: 'เรามอบข้อเสนอเชิงกลยุทธ์และข้อมูลการตลาดล่าสุดเพื่อเพิ่มศักยภาพให้กับพันธมิตรทั่วโลกของเรา', VN: 'Chúng tôi cung cấp các đề xuất chiến lược และ thông tin thị trường mới nhất để hỗ trợ đối tác.', ID: 'Kami memberikan proposal strategis dan kecerdasan pasar terbaru untuk memberdayakan mitra global kami.', MY: 'Kami menyediakan cadangan strategik and risikan pasaran terkini untuk memperkasakan rakan kongsi global kami.' },
      offers: [
        {
          ...
          desc: { 
            ...
            VN: 'Tiếp cận các kênh phân phối cao cấp และ chuỗi cung ứng ưu tiên được tối ưu hóa cho năm 2026.', 
        ...
        },
        {
          ...
          desc: { 
            ...
            VN: 'Thúc đẩy sự hiện diện thương hiệu của bạn tại thị trường Châu Á, Hoa Kỳ และ Châu Âu thông qua chuyên mônของ chúng tôi.', 
        ...
        {
          title: { EN: 'Logistics Optimization Initiative', KR: '물류 최적화 이니셔티브', CN: '物流优化计划', JP: '物流最適化イニシアチブ', TH: 'โครงการปรับปรุงโลจิสติกส์', VN: 'Sáng kiến tối ưu hóa hậu cần', ID: 'Inisiatif Optimalisasi Logistik', MY: 'Inisiatif Pengoptimuman Logistik' },
          desc: { EN: 'Reduce operational costs and improve delivery efficiency with our next-generation logistics network.', KR: '차세대 물류 네트워크를 통해 운영 비용을 절감하고 배송 효율성을 획기적으로 개선하세요.', CN: '通过我们的下一代物流网络，降低运营成本并提高交付效率。', JP: '次世代の物流ネットワークを通じて運営コストを削減し、配送効率を画期的に改善してください。', TH: 'ลดต้นทุนการดำเนินงานและเพิ่มประสิทธิภาพการจัดส่งด้วยเครือข่ายโลจิสติกส์ยุคใหม่ของเรา', VN: 'Giảm chi phí vận hành và cải thiện hiệu quả giao hàng với mạng lưới hậu cần thế hệ mớiของ chúng tôi.', ID: 'Kurangi biaya operasional dan tingkatkan efisiensi pengiriman dengan jaringan logistik generasi berikutnya kami.', MY: 'Kurangkan kos operasi and tingkatkan kecekapan penghantaran dengan rangkaian logistik generasi seterusnya kami.' },
  ...
  privacy: {
    ...
    intro: {
      ...
      VN: 'Tại J PRO Trading, chúng tôi tôn trọng quyền riêng tưของ bạn และ cam kết bảo vệ dữ liệu cá nhânของ bạn.',
    ...
    sections: [
      {
        ...
        content: { EN: 'We collect information you provide directly to us when contacting us through our messaging services or email.', KR: '우리는 메시지 서비스나 이메일을 통해 귀하가 직접 제공하는 정보를 수집합니다.', CN: '当您通过我们的消息服务或电子邮件与我们联系时，我们会收集您直接提供给我们的信息。', JP: 'メッセージサービスやメールを通じて直接提供された情報を収集します。', TH: 'เราเก็บรวบรวมข้อมูลที่คุณให้ไว้โดยตรงเมื่อติดต่อเราผ่านบริการส่งข้อความหรืออีเมล', VN: 'Chúng tôi thu thập thông tin bạn cung cấp trực tiếp cho chúng tôi khi liên hệ qua tin nhắn 또는 email.', ID: 'Kami mengumpulkan informasi yang Anda berikan langsung kepada kami saat menghubungi kami melalui layanan perpesanan 또는 email.', MY: 'Kami mengumpul maklumat yang anda berikan secara langsung kepada kami apabila menghubungi kami melalui perkhidmatan pesanan atau e-mel.' }
      },
      {
