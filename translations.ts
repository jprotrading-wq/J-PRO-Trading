...
export const translations = {
  ...
  about: {
    ...
    quote: {
      ...
      JP: "私たちは単なる取引を超え、パートナー企業の皆様の꿈을 현실にする架け橋となります。信頼は私たちの最大の資産であり、専門性は私たちの唯一의基準です。",
    ...
    p1: { 
      ...
      JP: 'J PRO Tradingは単なる商社ではなく、国際貿易の複雑な課題を共に解決していく戦略적파트너입니다. 우리는 모든 거래가 지속 가능한 신뢰를 쌓는 기회라고 믿습니다.', 
      ...
      MY: 'J PRO Trading bukan sekadar pengedar; kami adalah rakan strategik yang berdedikasi untuk mengemudi kerumitan perdagangan antarabangsa.'
    },
    p2: { 
      ...
      JP: '創業以来、米国、欧州、韓国、日本全域に拠点を拡大し、プレミアムブランドの輸出에 특화해 왔습니다.私たちのミッションは、グローバルな品質でローカル市場を活性化し、卓越性に国境がないことを証明することです。', 
      TH: 'นับตั้งแต่ก่อตั้ง เราได้ขยายฐานการดำเนินงานไปทั่วสหรัฐอเมริกา ยุโรป เกาหลี และญี่ปุ่น',
      VN: 'Kể từ khi thành lập, chúng tôi đã mở rộng phạm vi hoạt động khắp Hoa Kỳ, Châu Âu, Hàn Quốc và Nhật Bản.',
      ID: 'Sejak awal berdiri, kami telah memperluas jejak kami di AS, Eropa, Korea, dan Jepang, dengan spesialisasi ekspor merek premium.',
      MY: 'Sejak penubuhan kami, kami telah memperluas jejak kami di seluruh AS, Eropah, Korea, dan Jepun, khusus dalam eksport jenama premium.'
    },
    values: {
      ...
      v3: { EN: 'Mutual Growth', KR: '동반 성장', CN: '共同成长', JP: '共生共栄', TH: 'การเติ보ไปด้วยกัน', VN: 'Cùng nhau phát triển', ID: 'Pertumbuhan Bersama', MY: 'Pertumbuhan Bersama' },
  ...
  services: {
    ...
    subtitle: { EN: 'Comprehensive Trade Solutions', KR: '포괄적인 무역 솔루션', CN: '全面的贸易解决方案', JP: '包括的な贸易ソリューション', TH: 'โซลูชั่นการค้าที่ครอบคลุม', VN: 'Giải pháp thương mại toàn diện', ID: 'Solusi Perdagangan Komprehensif', MY: 'Penyelesaian Perdagangan Komprehensif' },
    ...
    pageHeader: { EN: 'Global Trade Excellence', KR: '글로벌 무역의 정점', CN: '全球贸易卓越', JP: 'グローバル贸易の頂点', TH: 'ความเป็นเลิศทางการค้าระหว่างประเทศ', VN: 'Xuất sắc trong thương mại toàn cầu', ID: 'Keunggulan Perdagangan Global', MY: 'Kecemerlangan Perdagangan Global' },
  ...
  news: {
    ...
    page: {
      ...
      desc: { EN: 'We provide strategic proposals and the latest market intelligence to empower our global partners.', KR: '우리는 글로벌 파트너들의 성장을 위해 전략적인 비즈니스 제안과 최신 시장 지능을 제공합니다.', CN: '我们提供战略建议和最新的市场情报，以为我们的全球合作伙伴赋能。', JP: 'グローバルパートナーの皆様の成長のために、戦略的なビジネス提案と最新の市場インテリジェンスを提供します。', TH: 'เรามอบข้อเสนอเชิงกลยุทธ์และข้อมูลการตลาดล่าสุด', VN: 'Chúng tôi cung cấp các đề xuất chiến lược và thông tin thị trường mới nhất để hỗ trợ đối tác.', ID: 'Kami memberikan proposal strategis dan kecerdasan pasar terbaru untuk memberdayakan mitra global kami.', MY: 'Kami menyediakan cadangan strategik and risikan pasaran terkini untuk memperkasakan rakan kongsi global kami.' },
      offers: [
        {
          ...
          desc: { 
            ...
            TH: 'เข้าถึงช่องทางการจัดจำหน่ายระดับพรีเมียมปี 2026', 
        ...
        },
        {
          ...
          desc: { 
            ...
            TH: 'ขยายการรับรู้แบรนด์ในตลาดเอเชีย สหรัฐอเมริกา และยุโรป ผ่านความเชี่ยวชาญท้องถิ่นที่ผ่านการพิสูจน์แล้วของเรา', 
        ...
        },
        {
          ...
          desc: { EN: 'Reduce operational costs and improve delivery efficiency with our next-generation logistics network.', KR: '차세대 물류 네트워크를 통해 운영 비용을 절감하고 배송 효율성을 획기적으로 개선하세요.', CN: '通过我们的下一代物流网络，降低运营成本并提高交付效率。', JP: '次世代の物流ネットワークを通じて運営コストを削減し、配送効率を画期的に改善してください。', TH: 'ลดต้นทุนการดำเนินงานด้วยเครือข่ายยุคใหม่', VN: 'Giảm chi phí vận hành và cải thiện hiệu quả giao hàng với mạng lưới hậu cần thế hệ mới của chúng tôi.', ID: 'Kurangi biaya operasional dan tingkatkan efisiensi pengiriman dengan jaringan logistik generasi berikutnya kami.', MY: 'Kurangkan kos operasi and tingkatkan kecekapan penghantaran dengan rangkaian logistik generasi seterusnya kami.' },
  ...
  privacy: {
    ...
    lastUpdated: { EN: 'Last Updated: February 20, 2024', KR: '최종 수정일: 2024년 2월 20일', CN: '最后更新：2024年2月20일', JP: '最終更新日：2024年2월 20일', TH: 'อัป데ตล่าสุด: 20 กุมภาพันธ์ 2024', VN: 'Cập nhật lần cuối: 20 tháng 2, 2024', ID: 'Terakhir Diperbarui: 20 Februari 2024', MY: 'Terakhir Dikemas Kini: 20 Februari 2024' },
    intro: {
      ...
      JP: 'J PRO Tradingでは、お客様のプライバシーを尊重し、個人データの保護에 努めています。',
      TH: 'ที่ J PRO Trading เราเคารพในความเป็นส่วนตัวของคุณ',
