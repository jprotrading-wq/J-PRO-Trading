...
export const translations = {
  ...
  news: {
    ...
    page: {
      ...
      desc: { EN: 'We provide strategic proposals and the latest market intelligence to empower our global partners.', KR: '우리는 글로벌 파트너들의 성장을 위해 전략적인 비즈니스 제안과 최신 시장 지능을 제공합니다.', CN: '我们提供战略建议和最新的市场情报，以为我们的全球合作伙伴赋能。', JP: 'グローバルパートナーの皆様の成長のために、戦略的なビジネス提案と最新の市場インテリジェンスを提供します。', TH: 'เรามอบข้อเสนอเชิงกลยุทธ์และข้อมูลการตลาดล่าสุด', VN: 'Chúng tôi cung cấp các đề xuất chiến lược và thông tin thị trường mới nhất để hỗ trợ đối tác.', ID: 'Kami memberikan proposal strategis dan kecerdasan pasar terbaru untuk memberdayakan mitra global kami.', MY: 'Kami menyediakan cadangan strategik dan risikan pasaran terkini untuk memperkasakan rakan kongsi global kami.' },
      offers: [
        {
          ...
          desc: { EN: 'Access premium distribution channels and prioritized supply chains optimized for the 2025 global market.', KR: '2025년 글로벌 시장에 최적화된 프리미엄 유통 채널과 우선 공급망을 확보하세요.', CN: '获取针对 2025 年全球市场优化的优质分销渠道和优先供应链。', JP: '2025年のグローバル市場に最適化されたプレミアム流通チャネルと優先的なサプライチェーンを確保してください。', TH: 'เข้าถึงช่องทางการจัดจำหน่ายระดับพรีเมียมปี 2025', VN: 'Tiếp cận các kênh phân phối cao cấp và chuỗi cung ứng ưu tiên được tối ưu hóa cho năm 2025.', ID: 'Akses saluran distribusi premium dan rantai pasokan prioritas yang dioptimalkan untuk pasar global 2025.', MY: 'Akses saluran pengedaran premium dan rantaian bekalan keutamaan yang dioptimumkan untuk pasaran global 2025.' },
        ...
        },
        {
          ...
          desc: { EN: 'Reduce operational costs and improve delivery efficiency with our next-generation logistics network.', KR: '차세대 물류 네트워크를 통해 운영 비용을 절감하고 배송 효율성을 획기적으로 개선하세요.', CN: '通过我们的下一代物流网络，降低运营成本并提高交付效率。', JP: '次世代の物流ネットワークを通じて運営コストを削減し、配送効率を画期的に改善してください。', TH: 'ลดต้นทุนการดำเนินงานด้วยเครือข่ายยุคใหม่', VN: 'Giảm chi phí vận hành và cải thiện hiệu quả giao hàng với mạng lưới hậu cần thế hệ mới của chúng tôi.', ID: 'Kurangi biaya operasional dan tingkatkan efisiensi pengiriman dengan jaringan logistik generasi berikutnya kami.', MY: 'Kurangkan kos operasi dan tingkatkan kecekapan penghantaran dengan rangkaian logistik generasi seterusnya kami.' },
  ...
  privacy: {
    ...
    intro: {
      ...
      MY: 'Di J PRO Trading, kami menghormati privasi anda dan komited untuk melindungi data peribadi anda.'
    },
    sections: [
      {
